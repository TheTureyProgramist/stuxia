...
const LOADING_PHRASES = [
  ...
  "Хочете, щоб ваш трек був на сайті? Надсилайте на пошту theturkeystudio@gmail.com",
  "Фан-арти безкоштовні, для роздрукування! І плоска 3д картина, краще виглядає на стіні, ніж на екрані.",
  ...
  "Стихія+ та Стихія Ультра, це не просто підписка, це підтримка сайту.",
  ...
  "Помилка 404, це жарт :)",
  "Джомолунгма: .... ...... 6 і 8",
  "Підтримайте будь ласка рекламою :)",
  ...
  "Льодовиковий період чи глобальне потепління, через 24роки.",
