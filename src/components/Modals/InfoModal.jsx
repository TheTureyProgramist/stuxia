    ...
    <Overlay $isClosing={isClosing} onClick={handleClose}>
      <Content $isClosing={isClosing} onClick={(e) => e.stopPropagation()}>
        ...
        <Text $index={12}>
          ...
          треків(Виняток: звуки індиків і вітру) та використовує їх виключно в
          ознайомчих цілях. Усі права належать їх законним власникам.
        </Text>
        <Text $index={13}>
          ...
          віртуальному з умовою посилання на Стихію). Зображення
          оригінальні(присутня водяна мітка тематики(автора) + збільшення
          контрасності)
        </Text>
        <Text $index={14}>
          ...
          домовитись, з розміщенням на сайті ми видалимо пісню через 24год. За
          умови, доказів, що ви дісно з компанії, а не користувач, що видає себе
          за неї. Якщо, після скарги ми відправили відповідь, але не отримували
          відповідь протягом 12днів, ми вважатимемо, що ви передумали.
        </Text>
        ...
        <Text $index={16}>
          ...
          <strong>
            За бажанням, заходьте під псевдонімом або не існуючою електронною
            поштою.
          </strong>
          .
        </Text>
        ...
        <Text $index={23}>
          Сервіс надається за принципом (as is). Ми не гарантуємо безперебійну
          роботу сайту у разі технічних збоїв на стороні провайдерів або
        ...
        <Text $index={28}>8.1. Підписки...</Text>
